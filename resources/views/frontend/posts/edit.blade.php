                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.posts.update", [$post->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="post_text" id="post_text">{!! old('post_text', $post->post_text) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="start_date" id="start_date" value="{{ old('start_date', $post->start_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="end_date" id="end_date" value="{{ old('end_date', $post->end_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ip_address" id="ip_address" value="{{ old('ip_address', $post->ip_address) }}">
